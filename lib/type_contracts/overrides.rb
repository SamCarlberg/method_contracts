...
module TypeContracts
  module Overrides
    ...
    def attr_accessor(first_property, *other)
      annotation = @__type_contracts__last_annotation
      @__type_contracts__last_annotation = nil
      return super unless self.is_a?(Module) && TypeContracts.config.enabled?
    ...
    def __clone_annotation_for_method(annotation, method_name)
      ...
      redefiner = ::TypeContracts::Annotations::MethodRedefinition.new(self, method_name, method_type: ::TypeContracts::Annotations::MethodRedefinition::INSTANCE_METHOD)
      new_annotation[:_redefiner] = redefiner

      (@__type_contracts__annotations ||= {})[method_name] = new_annotation
      new_annotation
    end
  end
end
